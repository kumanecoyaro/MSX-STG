...
; to unconditionally at the end of this chain instead - see above)
    ...
    CP 49  : JP Z,ALLOC_ZUM_SLOT
    CP 50  : JP Z,ALLOC_FLYER_SLOT
    ...
    CP 59  : JP Z,SPAWN_S2_ZACOII
    CP 60  : JP Z,SPAWN_S2_ZACOII_RED
    CP 61  : JP Z,ALLOC_ETANK_SLOT
    CP 62  : JP Z,ALLOC_FLYER_SLOT
    ...
    CP 69  : JP Z,SPAWN_S2_ZACOII
    CP 70  : JP Z,SPAWN_S2_ZACOII_RED
    CP 71  : JP Z,ALLOC_BIGZUM_SLOT
    CP 72  : JP Z,SPAWN_S2_ZACOII
    CP 73  : JP Z,SPAWN_S2_ZACOII
    CP 74  : JP Z,SPAWN_S2_ZACOII
    CP 75  : JP Z,SPAWN_S2_ZACOII_RED
    CP 76  : JP Z,SPAWN_S2_ZACOII
    CP 77  : JP Z,SPAWN_S2_ZACOII
    CP 78  : JP Z,ALLOC_ZUM_SLOT
    CP 79  : JP Z,ALLOC_FLYER_SLOT
    CP 80  : JP Z,ALLOC_ZUM_SLOT
    CP 81  : JP Z,ALLOC_FLYER_SLOT
    CP 82  : JP Z,SPAWN_S2_ZACOII
    CP 83  : JP Z,SPAWN_S2_ZACOII
    CP 84  : JP Z,SPAWN_S2_ZACOII
    ...
    CP 118 : JP Z,ALLOC_FLYER_SLOT
    CP 119 : JP Z,ALLOC_BIGZUM_SLOT
    CP 120 : JP Z,ALLOC_FLYER_SLOT
    CP 121 : JP Z,ALLOC_FLYER_SLOT
    CP 122 : JP Z,ALLOC_FLYER_SLOT
    CP 123 : JP Z,SPAWN_S2_ZACOII_RED
    CP 124 : JP Z,SPAWN_S2_ZACOII
    CP 125 : JP Z,SPAWN_S2_ZACOII
    CP 126 : JP Z,SPAWN_S2_ZACOII
    CP 127 : JP Z,SPAWN_S2_ZACOII
    CP 128 : JP Z,SPAWN_S2_ZACOII
    CP 129 : JP Z,SPAWN_S2_ZACOII
    CP 130 : JP Z,SPAWN_S2_ZACOII
    CP 131 : JP Z,SPAWN_S2_ZACOII
    CP 132 : JP Z,SPAWN_S2_ZACOII
    CP 133 : JP Z,SPAWN_S2_ZACOII_RED
    CP 134 : JP Z,ALLOC_ZUM_SLOT
    CP 135 : JP Z,SPAWN_S2_ZACOII
    CP 136 : JP Z,ALLOC_ZUM_SLOT
    CP 137 : JP Z,SPAWN_S2_ZACOII
    CP 138 : JP Z,ALLOC_ZUM_SLOT
    ...
    CP 144 : JP Z,ALLOC_ETANK_SLOT
    CP 145 : JP Z,SPAWN_S2_ZACOII
    CP 146 : JP Z,SPAWN_S2_ZACOII
    CP 147 : JP Z,SPAWN_S2_ZACOII
    CP 148 : JP Z,SPAWN_S2_ZACOII
    CP 149 : JP Z,SPAWN_S2_ZACOII
    CP 150 : JP Z,SPAWN_S2_ZACOII
    CP 151 : JP Z,ALLOC_BIGZUM_SLOT
    CP 152 : JP Z,SPAWN_S2_ZACOII
    CP 153 : JP Z,SPAWN_S2_ZACOII
    CP 154 : JP Z,SPAWN_S2_ZACOII
    CP 155 : JP Z,SPAWN_S2_ZACOII_RED
    CP 156 : JP Z,ALLOC_FLYER_SLOT
    CP 157 : JP Z,ALLOC_FLYER_SLOT
    CP 158 : JP Z,ALLOC_FLYER_SLOT
    CP 159 : JP Z,ALLOC_FLYER_SLOT
    CP 160 : JP Z,SPAWN_S2_ZACOII
    CP 161 : JP Z,SPAWN_S2_ZACOII
    CP 162 : JP Z,SPAWN_S2_ZACOII_RED
    CP 163 : JP Z,SPAWN_S2_ZACOII
    CP 164 : JP Z,SPAWN_S2_ZACOII
    ; index165 (the last entry, boss) needs no CP of its own - by this
    ; point SPAWN2_NEXT_INDEX can only be 165, same "falls through"
...
SPAWN2_THRESHOLDS:
    ...
    DW 225,232,242,259,260,263,267,280
    DW 284,292,295,298,307,309,310,316
    DW 321,325,326,334,335,344,355,355
    DW 355,362,363,363,372,381,386,395
    DW 397,401,403,407,411,413,428,429
    DW 463,469,475,486,506,506,512,517
    DW 517,524,535,535,539,546,546,550
    DW 555,556,560,565,577,580,587,591
    DW 597,604,604,604,613,613,622,633
    DW 635,639,659,675,677,682,684,688
    DW 691,693,697,700,701,705,712,724
    DW 725,736,747,760,768,770,774,777
    DW 779,783,784,786,789,808,830,832
    DW 835,837,841,842,849,855,866,869
    DW 869,877,878,882,885,887,890,894
...
SPAWN2_Y_TABLE:
    ...
    DB 48,144,144,88,56,96,64,24,104,72,32,72
    DB 144,144,32,88,16,64,24,48,80,32,64,96
    DB 80,128,32,80,24,104,64,16,96,48,40,128
    DB 72,72,72,48,40,120,168,80,168,32,64,88
    DB 24,56,88,24,96,56,24,56,88,32,32,104
    DB 56,24,72,112,40,80,64,104,64,24,128,88
    DB 56,88,56,24,96,56,24,104,64,32,80,128
    DB 24,88,40,64,104,72,32,104,64,24,104,72
    DB 32,72,144,72,144,56,144,24,80,40,88,48
    DB 128,104,72,40,112,80,40,128,120,88,40,72
    DB 88,32,88,32,112,40,64,8,96,104
