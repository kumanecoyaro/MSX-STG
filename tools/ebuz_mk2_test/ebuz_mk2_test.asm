...
; までの範囲で」を受けMAX_ROW=13(ガード帯row20-23の物理限界値)へ
; 変更したが、これはユーザーの意図(前回値8から単純に+4)と異なって
; いたとの指摘「下にあと4セル広げりゃいいんだよ...Row0からRow12まで
; が移動範囲」を受け、MAX_ROWを13→12へ再修正(8+4=12)。
