"""tools/ebuz_mk2_test/ebuz_mk2_test.asm を素の16KB MSX ROM(バンク
切替不要、ASCII16マッパー無し)としてビルドする。tools/ebuz_test/
build_test.pyと同一の作法(BankedMem不使用のフラット16KB ROM)。
"""
import os
import sys
...
def main():
    ...
    for addr, val in out.items():
        ...
        rom[addr - 0x4000] = val
    rom_path = os.path.join(HERE, "EbuzMk2Test.rom")
