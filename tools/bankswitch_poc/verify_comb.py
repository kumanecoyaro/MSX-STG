...
# 適用する。
_RSS_MAIN_LOOP_COUNT_ADDR = tsym["RUN_SCREEN3_SLIDESHOW"] + 0x67  # "LD B,3" operand (round97 shifted by the name-table transfer loop; +3 by round99follow-up's SC3_CT_PHASE init; +8 by the skip-to-Mission1 SP-save prologue; +3 by round103's SC3_CT_PASS init)
